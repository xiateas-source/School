...
import { QUICK_ACTION_BY_CODE, CAPS, clamp } from './shared/rewards.js?v=efa6a9e2';
import { amountIntegrity, normalizeTransaction } from './shared/ledger.js?v=efa6a9e2';
import { FEEDBACK_TYPE, DELIVERY, recognitionEventId } from './shared/feedback.js?v=efa6a9e2';
...
} from './shared/corrections.js?v=efa6a9e2';
