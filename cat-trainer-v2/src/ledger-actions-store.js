...
import { QUICK_ACTION_BY_CODE, CAPS, clamp } from './shared/rewards.js?v=7ce7969f';
import { amountIntegrity, normalizeTransaction } from './shared/ledger.js?v=7ce7969f';
import { FEEDBACK_TYPE, DELIVERY, recognitionEventId } from './shared/feedback.js?v=7ce7969f';
...
} from './shared/corrections.js?v=7ce7969f';
