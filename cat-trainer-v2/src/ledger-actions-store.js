...
import { initFirebase, db, dbSdk } from './firebase.js?v=7bbfa534';
import { QUICK_ACTION_BY_CODE, CAPS, clamp } from './shared/rewards.js?v=7bbfa534';
import { amountIntegrity, normalizeTransaction } from './shared/ledger.js?v=7bbfa534';
import { FEEDBACK_TYPE, DELIVERY, recognitionEventId } from './shared/feedback.js?v=7bbfa534';
import { localDate, localTimeLabel } from './shared/dates.js?v=7bbfa534';
import {
...
} from './shared/corrections.js?v=7bbfa534';
