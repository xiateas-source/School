...
import { initFirebase, db, dbSdk } from './firebase.js?v=a6cb40f2';
import { QUICK_ACTION_BY_CODE, CAPS, clamp } from './shared/rewards.js?v=a6cb40f2';
import { amountIntegrity, normalizeTransaction } from './shared/ledger.js?v=a6cb40f2';
import { FEEDBACK_TYPE, DELIVERY, recognitionEventId } from './shared/feedback.js?v=a6cb40f2';
import { localDate, localTimeLabel } from './shared/dates.js?v=a6cb40f2';
import {
...
} from './shared/corrections.js?v=a6cb40f2';
