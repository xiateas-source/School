...
import { QUICK_ACTION_BY_CODE, CAPS, clamp } from './shared/rewards.js?v=08d5a06b';
import { amountIntegrity, normalizeTransaction } from './shared/ledger.js?v=08d5a06b';
import { FEEDBACK_TYPE, DELIVERY, recognitionEventId } from './shared/feedback.js?v=08d5a06b';
...
} from './shared/corrections.js?v=08d5a06b';
