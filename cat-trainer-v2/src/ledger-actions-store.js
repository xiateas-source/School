...
import { QUICK_ACTION_BY_CODE, CAPS, clamp } from './shared/rewards.js?v=b3b3c1a2';
import { amountIntegrity, normalizeTransaction } from './shared/ledger.js?v=b3b3c1a2';
import { FEEDBACK_TYPE, DELIVERY, recognitionEventId } from './shared/feedback.js?v=b3b3c1a2';
...
} from './shared/corrections.js?v=b3b3c1a2';
