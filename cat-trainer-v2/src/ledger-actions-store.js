...
import { initFirebase, db, dbSdk } from './firebase.js?v=2744110b';
import { QUICK_ACTION_BY_CODE, CAPS, clamp } from './shared/rewards.js?v=2744110b';
import { amountIntegrity, normalizeTransaction } from './shared/ledger.js?v=2744110b';
import { FEEDBACK_TYPE, DELIVERY, recognitionEventId } from './shared/feedback.js?v=2744110b';
import { localDate, localTimeLabel } from './shared/dates.js?v=2744110b';
import {
...
} from './shared/corrections.js?v=2744110b';
