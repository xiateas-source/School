...
import { deviceFamilyId, deviceUid, deviceRole } from './auth.js?v=79769391';
import * as store from './store.js?v=79769391';
import { QUICK_ACTIONS } from './shared/rewards.js?v=79769391';
import { localDate } from './shared/dates.js?v=79769391';
import { reversibleRewardEffects } from './shared/corrections.js?v=79769391';
import {
  correctTransaction, permanentDeleteTransaction, getLatestCorrectableTransaction,
  getTransaction, awardHeroReset
} from './ledger-actions-store.js?v=79769391';
