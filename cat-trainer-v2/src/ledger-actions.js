...
import { deviceFamilyId, deviceUid, deviceRole } from './auth.js?v=03696e99';
import * as store from './store.js?v=03696e99';
import { QUICK_ACTIONS } from './shared/rewards.js?v=03696e99';
import { localDate } from './shared/dates.js?v=03696e99';
import { reversibleRewardEffects } from './shared/corrections.js?v=03696e99';
import {
  correctTransaction, permanentDeleteTransaction, getLatestCorrectableTransaction,
  getTransaction, awardHeroReset
} from './ledger-actions-store.js?v=03696e99';
