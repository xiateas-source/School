...
export const CAFE_ITEMS = {
  rug:        { id: 'rug',        name: 'Blue Yarn',        price: 4,  role: 'play',  need: 'happiness', art: 'assets/yarn-blue.png',        className: 'decor-yarn-blue' },
  bed:        { id: 'bed',        name: 'Blue Star Bed',    price: 6,  role: 'rest',  need: 'rest',      art: 'assets/bed-blue-stars.png',   className: 'decor-bed-blue' },
  plant:      { id: 'plant',      name: 'Paw-Print Plant',  price: 8,  role: 'decor', art: 'assets/plant.png',            className: 'decor-plant-png' },
  tower:      { id: 'tower',      name: 'Cat Tree',         price: 12, role: 'play',  need: 'happiness', art: 'assets/cat-tree.png',         className: 'decor-cat-tree' },
  pinkBed:    { id: 'pinkBed',    name: 'Pink Heart Bed',   price: 7,  role: 'rest',  need: 'rest',      art: 'assets/bed-pink-hearts.png',  className: 'decor-bed-pink' },
  ...
  pinkYarn:   { id: 'pinkYarn',   name: 'Pink Yarn',        price: 4,  role: 'play',  need: 'happiness', art: 'assets/yarn-pink.png',        className: 'decor-yarn-pink' },
  bookshelf:  { id: 'bookshelf',  name: 'Cat Bookshelf',    price: 14, role: 'decor', art: 'assets/bookshelf.png',        className: 'decor-bookshelf' },
  toyBasket:  { id: 'toyBasket',  name: 'Toy Basket',       price: 9,  role: 'play',  need: 'happiness', art: 'assets/toy-basket.png',       className: 'decor-toy-basket' },
  ...
  petPillow:  { id: 'petPillow',  name: 'Mint Pillow',      price: 6,  role: 'rest',  need: 'rest',      art: 'assets/pet-pillow-mint.png',  className: 'decor-pet-pillow' },
  greenBed:   { id: 'greenBed',   name: 'Green Paw Bed',    price: 7,  role: 'rest',  need: 'rest',      art: 'assets/bed-green-paws.png',   className: 'decor-bed-green' },
  ...
  petHouse:   { id: 'petHouse',   name: 'Cat House',        price: 15, role: 'rest',  need: 'rest',      art: 'assets/pet-house-green.png',  className: 'decor-pet-house' },
