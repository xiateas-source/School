...
import { initFirebase, db, dbSdk } from './firebase.js?v=79769391';
import { CAT_IDS, CAT_DEFS, freshCatProgress } from './data/cats.js?v=79769391';
import { seededQuests } from './data/quests.js?v=79769391';
import { CAFE_ITEMS } from './data/cafe-items.js?v=79769391';
import {
...
import { localDate, localTimeLabel } from './shared/dates.js?v=79769391';
import {
  generatePairingCode, isPairingCodeShape, isPairingUsable, pairingErrorMessage
} from './shared/pairing.js?v=79769391';
import { presetTargets } from './shared/routines.js?v=79769391';
import {
